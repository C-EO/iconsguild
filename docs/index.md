...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: GitHub
      link: https://github.com/c-eo/iconsguild
...
features:
  ...
  - title: Packages support
    details: IconsGuild is available as a package for all major package managers.
    icon: |
  ...
  - title: Active community
    details: IconsGuild has an active community on GitHub and Discord.
    icon: |
